...
import { ScrapedContent, BilingualText, ImageAsset } from '@/types/content'
...
export class ContentScraper {
   ...
   */
  private async fetchContent(_url: string, _prompt: string): Promise<string> {
  ...
  async scrapeVisionMission(): Promise<ScrapedContent> {
  ...
  async scrapeBackground(section: 'sppp' | 'teluk-ewa'): Promise<ScrapedContent> {
  ...
  async scrapeFacility(facilitySlug: string): Promise<ScrapedContent> {
  ...
  async scrapeOrganizationChart(): Promise<ScrapedContent> {
  ...
  async scrapeContactInfo(): Promise<ScrapedContent> {
...
export const contentUtils = {
   ...
   */
  extractContactInfo(text: string): { phone?: string; fax?: string; email?: string } {
