  ...
  React.useEffect(() => {
    if (state.isOpen && state.currentSession && state.currentSession.messages.length === 0) {
      const welcomeMessage = state.language === 'BM'
        ? "Selamat datang! Saya Kapten, pembantu AI SPPP. Bagaimana saya boleh membantu anda hari ini?"
        : "Welcome! I'm Captain, your SPPP AI assistant. How can I help you today?"
