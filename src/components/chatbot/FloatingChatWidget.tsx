      ...
      >
        ...
        <div className="relative w-full h-full rounded-full overflow-hidden">
          {state.isOpen ? (
            ...
            <div className="relative w-full h-full rounded-full overflow-hidden">
              <Image
                src="/images/ai-chatbot-captain.png"
                alt="Kapten - Pembantu Maya SPPP"
                width={64}
                height={64}
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/50 to-transparent rounded-b-full">
                <span className="text-xs font-medium text-white block text-center pb-1">Kapten</span>
              </div>
            </div>
          )}
        </div>
        ...
        {!state.isOpen && !state.currentSession && (
          ...
          >
            ...
            <div className="text-xs text-sppp-gray">
              Pembantu AI SPPP. Klik untuk memulakan perbualan!
            </div>
            {/* Speech bubble tail */}
