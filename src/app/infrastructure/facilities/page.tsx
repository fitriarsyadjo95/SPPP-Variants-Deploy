...
import { InteractivePortInfographic } from '@/components/ui/interactive-port-infographic';
import { AnimatedStatsGrid } from '@/components/ui/animated-counter';
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          {/* Animated Overview Statistics */}
          <section className="mb-16">
            <AnimatedStatsGrid
              title="Ringkasan Kemudahan Pelabuhan"
              subtitle="Infrastruktur moden dengan kapasiti tinggi untuk operasi pelabuhan yang efisien"
              stats={[
                {
                  ...
                  suffix: 'M',
                  label: 'TEU Capacity',
                  description: 'Kapasiti kontena tahunan',
                  color: 'blue',
                  decimals: 1
                },
                {
                  ...
                  value: 8,
                  label: 'Berth Positions',
                  description: 'Posisi dermaga aktif',
                  color: 'green'
                },
                {
                  ...
                  suffix: 'K',
                  label: 'm² Warehouse',
                  description: 'Ruang gudang tertutup',
                  color: 'orange'
                },
                {
          ...
          {/* Interactive Port Infographic */}
          <section className="mb-16">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                Layout Kemudahan Pelabuhan Interaktif
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Jelajahi kemudahan pelabuhan kami melalui visualisasi interaktif yang menunjukkan
                lokasi dan maklumat terperinci setiap kemudahan.
              </p>
            </div>
            <InteractivePortInfographic className="mb-12" />
          </section>
