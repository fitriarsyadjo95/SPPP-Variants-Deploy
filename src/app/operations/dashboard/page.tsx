...
const cargoThroughputData = [
  { year: '2021', cargo: 29.18, container: 1.28, ferry: 0.80, telukEwa: 2.36 },
  { year: '2022', cargo: 30.15, container: 1.30, ferry: 1.54, telukEwa: 2.11 },
  { year: '2023', cargo: 32.09, container: 1.44, ferry: 2.20, telukEwa: 1.93 },
  { year: '2024', cargo: 32.33, container: 1.42, ferry: 2.86, telukEwa: 2.00 }
]

const commodityBreakdown = [
  { name: 'Berkontena', value: 70.6, color: '#3B82F6' },
  { name: 'Cecair Pukal', value: 13.4, color: '#10B981' },
  { name: 'Kering Pukal', value: 10.1, color: '#F59E0B' },
  { name: 'Pecah Pukal', value: 5.8, color: '#EF4444' }
]

const monthlyPerformance = [
  { month: 'Jan', cargo: 2.8, container: 0.12, target: 2.7 },
  { month: 'Feb', cargo: 2.9, container: 0.11, target: 2.7 },
  { month: 'Mar', cargo: 3.1, container: 0.13, target: 2.7 },
  { month: 'Apr', cargo: 2.7, container: 0.12, target: 2.7 },
  { month: 'May', cargo: 2.8, container: 0.11, target: 2.7 },
  { month: 'Jun', cargo: 2.6, container: 0.10, target: 2.7 }
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-sppp-gray">Kargo 2024</p>
                <p className="text-2xl font-bold text-sppp-dark-blue">32.3M</p>
                <p className="text-xs text-green-600">+1.0% dari 2023</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-sppp-gray">Kontena 2024</p>
                <p className="text-2xl font-bold text-sppp-dark-blue">1.42M</p>
                <p className="text-xs text-red-600">-1.9% dari 2023</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-sppp-gray">Feri 2024</p>
                <p className="text-2xl font-bold text-sppp-dark-blue">2.86M</p>
                <p className="text-xs text-green-600">+29.9% dari 2023</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-sppp-gray">Teluk Ewa 2024</p>
                <p className="text-2xl font-bold text-sppp-dark-blue">2.00M</p>
                <p className="text-xs text-green-600">+3.7% dari 2023</p>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-lg shadow-sm border">
            <div className="p-4 border-b">
              <h3 className="text-lg font-semibold text-sppp-dark-blue flex items-center">
                <ArrowTrendingUpIcon className="w-5 h-5 mr-2" />
                Trend Throughput Tahunan
              </h3>
            </div>
            <div className="p-4">
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={cargoThroughputData}>
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="year" />
                  <YAxis />
                  <Tooltip formatter={(value, name) => [value + 'M', name]} />
                  <Line type="monotone" dataKey="cargo" stroke="#3B82F6" strokeWidth={3} name="Kargo (Tan)" />
                  <Line type="monotone" dataKey="container" stroke="#10B981" strokeWidth={2} name="Kontena (TEU)" />
                  <Line type="monotone" dataKey="ferry" stroke="#F59E0B" strokeWidth={2} name="Feri (Penumpang)" />
                  <Line type="monotone" dataKey="telukEwa" stroke="#EF4444" strokeWidth={2} name="Teluk Ewa (Tan)" />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border">
            <div className="p-4 border-b">
              <h3 className="text-lg font-semibold text-sppp-dark-blue">Komposisi Kargo 2024</h3>
            </div>
            <div className="p-4">
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
        ...
        <div className="bg-white rounded-lg shadow-sm border mb-8">
          <div className="p-4 border-b">
            <h3 className="text-lg font-semibold text-sppp-dark-blue">Prestasi Bulanan 2024</h3>
          </div>
          <div className="p-4">
            <ResponsiveContainer width="100%" height={250}>
              <BarChart data={monthlyPerformance}>
                ...
                <YAxis />
                <Tooltip formatter={(value, name) => [value + 'M', name]} />
                <Bar dataKey="cargo" fill="#3B82F6" name="Kargo Sebenar" />
                <Bar dataKey="target" fill="#E5E7EB" name="Sasaran" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
                ...
                {dummyShips.map((ship, index) => (
                  ...
                  >
                    <div className="bg-white rounded-full p-2 shadow-lg border-2 border-sppp-blue">
                      <span className="text-xl">{getVesselIcon(ship.type)}</span>
                    </div>
                ...
                {dummyShips.map((ship) => (
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex items-center">
                        <span className="text-lg mr-2">{getVesselIcon(ship.type)}</span>
                        <div>
